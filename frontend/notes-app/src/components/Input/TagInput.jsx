...
const TagInput = ({tags,setTags}) => {
  ...
  return (
    <div>
            ...
            {
            tags.map((tag,index)=>(
                <span key={index} className='flex items-center items-center gap-2 text-sm text-slate-900 bg-slate-100 px-3 py-1 rounded'>#{tag}
        ...
        <div className='flex items-center gap-4 mt-3'>
            ...
            value={inputValue}
            placeholder='Add tags' onChange={handleInputChange} onKeyDown={handlekeyDown}/>
